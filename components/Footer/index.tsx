...
import { StarFooter } from "@/common/Star";
    ...
    >
      ...
      >
        <div className="2xl:w-[80%] 2xl:px-0 w-full h-full md:p-[25px] px-[15px]">
          <div className="h-[90%] flex flex-col justify-between md:space-y-[25px]">
            <div className=" md:mb-[50px] flex lg:flex-row flex-col md:justify-between justify-evenly items-center lg:h-auto h-full md:py-[30px]">
              <div className="flex md:flex-row flex-col-reverse md:items-center md:space-x-[15px] ">
                ...
                <h2 className="lg:text-start text-center">
                  ...
                  <span className="md:block xl:ml-[100px] md:mt-[30px]">
            ...
            <div className="w-full md:h-full h-auto flex items-end justify-between ">
              <svg
                ...
                className="w-[75%] h-auto md:block hidden"
              >
                <g clipPath="url(#clip0_112_2)">
                  <path
                    ...
                    fill="#E9BC5A"
                    className="fill-border opacity-30"
                  />
                </g>
                <defs>
              ...
              <div className="flex flex-col md:items-end justify-between py-[20px]">
                <div className="flex flex-col">
                  <div className="flex flex-col md:mr-[40px] mb-[20px]">
          ...
          <div className=" h-[10%] border-t border-border flex md:items-center items-end justify-between md:text-base text-sm">
            <div className="flex flex-col">
