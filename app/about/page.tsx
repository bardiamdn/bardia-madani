        ...
        <div>
          ...
          <div className="flex flex-col gap-[25px] py-[35px] border-b-[0.5px] border-border">
            ...
            <p>
              ...
              time to learn about your business, your industry, and your
          ...
          <div className="flex flex-col gap-[25px] py-[35px] border-b-[0.5px] border-border">
            ...
            <p>
              ...
              pages, blog posts, or product descriptions, I ensure your message
              is clear, engaging, and optimized for conversions.
            </p>
          </div>
          <div className="flex flex-col gap-[25px] py-[35px] border-b-[0.5px] border-border">
            <div className="inline-flex gap-[15px]">
            ...
            <p>
              ...
              your brand&apos;s identity while ensuring a seamless user
              experience across all devices. This step brings your vision to
              life with attention to aesthetics, usability, and engagement.
            </p>
          </div>
          <div className="flex flex-col gap-[25px] py-[35px] border-b-[0.5px] border-border">
            <div className="inline-flex gap-[15px]">
            ...
            <p>
              ...
              efficient code that ensures speed, security, and SEO-friendliness.
              I integrate all necessary features, from contact forms to payment
              gateways, making sure your site is functional, responsive, and
              built to scale.
            </p>
          </div>
          <div className="flex flex-col gap-[25px] py-[35px]">
            ...
            <p>
              A website is never truly “finished.” To keep it running smoothly,
              I offer ongoing updates, security monitoring, and performance
