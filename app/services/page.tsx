  ...
  return (
    <section className="bg-white flex flex-col px-[15px] py-[50px]">
      ...
      <div className="border-b-[0.5px] border-border py-[40px]">
        <h2 className="my-[20px] ">Web Design</h2>
        <p className="text-foregroundLight">
          I create visually appealing, user-friendly websites designed to
          capture attention and drive conversions. A well-structured design
          ensures visitors stay engaged and take action.
        </p>
      </div>
      <div className="border-b-[0.5px] border-border py-[40px]">
        <h2 className="my-[20px] ">Web Development</h2>
        <p className="text-foregroundLight">
          A well-built website is the foundation of your online presence. With
          clean, efficient code and best practices, I develop websites that are
          fast, scalable, and optimized for search engines—helping you rank on
          Google without relying solely on ads.
        </p>
      </div>
      <div className="border-b-[0.5px] border-border py-[40px]">
      ...
      <div className="border-b-[0.5px] border-border py-[40px]">
        ...
        <p className="text-foregroundLight">
          ...
          secure, and always accessible. With regular backups, SSL certificates,
          and security measures, I help protect your site from threats and
          downtime.
        </p>
      </div>
      <div className="border-b-[0.5px] border-border py-[40px]">
      ...
      <div className="border-b-[0.5px] border-border py-[40px]">
        ...
        <p className="text-foregroundLight">
          ...
          campaigns. Whether it’s Google Ads, social media, or email marketing,
          I create and manage campaigns that drive traffic and increase
          conversions.
        </p>
      </div>
